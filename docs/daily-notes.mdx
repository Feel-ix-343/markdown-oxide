---
title: "Daily Notes"
description: "Working with daily notes in Markdown-Oxide"
---
...
These follow https://docs.rs/fuzzydate/latest/fuzzydate/ where the relative name must follow the specification for `<datetime>` in the fuzzydate specification below:

<Accordion title="fuzzydate's specification">
  ```
  <datetime> ::= <time>
               | <date> <time>
               | <date> , <time>
...
Here are some examples for neovim daily note commands (as specified in the setup [here](/setup-instructions#neovim))
