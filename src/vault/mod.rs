...
Some content here";
    ...
    fn test_relative_path_resolution() {
        ...
        assert!(matches, "Relative path ./sub_dir/target should resolve to current_dir/sub_dir/target.md");
    }
    ...
    fn test_parent_dir_path_resolution() {
        ...
        assert!(matches, "Relative path ../target should resolve to target.md in root");
    }
}
